...
```{r}
knn_df <- subset(knn_df, select = -c(Diabetes, Heart_Disease_imp, Depression_imp,
                                     Ment_Health_imp, Gen_Health_imp, Phys_Health_imp, 
                                     Health_Cov_imp, Med_Cost_imp, BP_imp,  Chol_imp,
                                     Stroke_imp, Diabetes_imp,Sex_imp, Education_imp,
                                     Income_imp, BMI_imp, Smoking_imp, Avg_Drinks_imp,
                                     Exercise_imp, Age_Groups_imp, Fruit_imp,Veggies_imp))
```
...
hd_labels <-  knn_df %>% select(Heart_Disease)
knn_df <- knn_df %>% select(-Heart_Disease)
